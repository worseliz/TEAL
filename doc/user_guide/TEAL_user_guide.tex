...
\title{Tool for Economic AnaLysis (TEAL) User Guide \\
...
\author{ \\Elizabeth Worsham, ...\\}

\date{}
\SANDnum{INL/EXT-21-63222-Rev000}
\SANDprintDate{\today}
\SANDauthor{Elizabeth Worsham...}
...
%INSERT_SECTIONS_HERE
    ...
    \bibliography{build/TEAL_user_manual}
    \end{document}
